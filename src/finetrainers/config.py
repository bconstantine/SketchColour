...
from .models.cogvideox import CogVideoXModelSpecification, CogVideoXControlModelSpecification
...
SUPPORTED_MODEL_CONFIGS = {
    ...
    ModelType.COGVIDEOX: {
        ...
        TrainingType.CONTROL_LORA: CogVideoXControlModelSpecification, 
    },
    ModelType.COGVIEW4: {
