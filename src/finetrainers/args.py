...
class BaseArgs:
    ...
    force_every_validation_to_be_bfloat16:bool = True 
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        validation_arguments = {
            ...
            "force_every_validation_to_be_bfloat16": self.force_every_validation_to_be_bfloat16,
        }
...
def _add_model_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--image_pipeline", action="store_true")
...
def _add_validation_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--force_every_validation_to_be_bfloat16", action="store_true")
...
def _map_to_args_type(args: Dict[str, Any]) -> BaseArgs:
    ...
    result_args.disable_validation = args.disable_validation
    result_args.force_every_validation_to_be_bfloat16 = args.force_every_validation_to_be_bfloat16
...
def _validate_validation_args(args: BaseArgs):
    ...
    logger.info("Disable validation at this moment is: ")
    logger.info(args.disable_validation)
    logger.info("force_every_validation_to_be_bfloat16 at the moment is")
    logger.info(args.force_every_validation_to_be_bfloat16)
