...
class ControlType(str, Enum):
    ...
    CUSTOM = "custom"
    NONE = "none"
    CUSTOM_GUIDANCE_INTERP = "custom_guidance_interp"
...
class ControlLowRankConfig(ArgsConfigMixin):
    ...
    frame_conditioning_indices: List[int] = [0]
    ...
    def add_args(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument("--frame_conditioning_indices", type=int, nargs="+", default=[0])
    ...
    def map_args(self, argparse_args: argparse.Namespace, mapped_args: "BaseArgs"):
        ...
        mapped_args.frame_conditioning_indices = argparse_args.frame_conditioning_indices
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "frame_conditioning_indices": self.frame_conditioning_indices
        }
